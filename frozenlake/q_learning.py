...
class ReinforcementLearner:
    ...
    '''
        Format and print the values of the q-table to stout
    '''
    ...
    '''
        Performs the learning function (manages the running of episodes)
    '''
    def learn(self):
        # for each episode
    ...
    '''
        Updates the policy Q(s,a) using Bellman equation
    '''
    ...
    '''
        Defines the sigmoid function for use in determining exploration rate
    '''
    ...
    '''
        Change the exploration rate using the Sigmoid Logistic function (to constrain values between [0,1])
    '''
    ...
    '''
        Change the exploration rate with the Cosine function 
    '''
    ...
    '''
        Decrease the exploration rate linearly 
    '''
    ...
    '''
        Start the next episode of the training
    '''
    ...
    '''
        Plot a linear regression of the training statistics  
    '''
    @staticmethod
    ...
    def display_stats(self):
        ...
        axs[1].title.set_text('Exploration Rate During Training')
        x_e = list(range(len(self.exploration_values)))
        y_e = self.exploration_values
        axs[1].plot(x_tr, y_e)
        axs[1].set(xlabel='# of Episodes', ylabel='Exploration Rate')
